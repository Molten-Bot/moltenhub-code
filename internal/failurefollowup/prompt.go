...
const ValidationToolingInstruction = "If local test or validation tooling is unavailable in this runtime (for example `command not found`), do not fail solely for that. Continue with repository changes, run any alternative checks you can, and clearly report the validation gap."
