...
func sampleConfig() config.Config {
	return config.Config{
		...
		PRBody:        "[Automated change generated by Molten Hub Code.](https://molten.bot/code)\n\nStandard PR format reference: https://github.com/Molten-Bot/moltenhub-code/pull/580\n\nAgent summary of issue resolution:\nAutomated by MoltenHub Code\n\nOriginal task prompt:\n```text\nBuild API\n```\n\nIf you would like to connect agents together checkout [Molten Bot Hub](https://molten.bot/hub).",
...
func TestRunBuildsReviewContextBeforeInvokingCodex(t *testing.T) {
	...
	cfg.PRBody = "[Automated change generated by Molten Hub Code.](https://molten.bot/code)\n\nStandard PR format reference: https://github.com/Molten-Bot/moltenhub-code/pull/580\n\nAgent summary of issue resolution:\nAutomated by MoltenHub Code\n\nOriginal task prompt:\n```text\nReview the pull request\n```\n\nIf you would like to connect agents together checkout [Molten Bot Hub](https://molten.bot/hub)."
...
func TestPRCreateCommandsEnforceStandardBodyFormat(t *testing.T) {
	...
	required := []string{
		"[Automated change generated by Molten Hub Code.](https://molten.bot/code)",
		"Standard PR format reference: https://github.com/Molten-Bot/moltenhub-code/pull/580",
	...
	if got := strings.Count(body, "Standard PR format reference: https://github.com/Molten-Bot/moltenhub-code/pull/580"); got != 1 {
		t.Fatalf("normalized PR body reference count = %d, want 1", got)
	}
	if got := strings.Count(body, "Agent summary of issue resolution:"); got != 1 {
		t.Fatalf("normalized PR body summary heading count = %d, want 1", got)
	}
