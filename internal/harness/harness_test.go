...
func TestRunBuildsReviewContextBeforeInvokingCodex(t *testing.T) {
	...
	cfg.PRBody = "Automated change generated by Molten Hub Code.\n\nStandard PR format reference: https://github.com/Molten-Bot/moltenhub-code/pull/580\n\nAgent summary of issue resolution:\nAutomated by MoltenHub Code\n\nOriginal task prompt:\n```text\nReview the pull request\n```\n\nIf you would like to connect agents together checkout [Molten Bot Hub](https://molten.bot/hub)."
...
func TestPRCreateCommandsEnforceStandardBodyFormat(t *testing.T) {
	...
	required := []string{
		"Automated change generated by Molten Hub Code.",
		"Standard PR format reference: https://github.com/Molten-Bot/moltenhub-code/pull/580",
