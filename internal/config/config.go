...
const prBodyGeneratedByLine = "[Automated change generated by Molten Hub Code.](https://molten.bot/code)"
...
const prBodySummaryHeading = "Agent summary of issue resolution:"
const prBodyDefaultSummary = "Implemented requested repository updates."
...
func extractPRBodySummary(body string) string {
	...
	body = strings.TrimSpace(strings.ReplaceAll(body, prBodySummaryHeading, ""))
