...
// MarkOpenClawOffline is a compatibility wrapper for runtime offline.
...
// PullOpenClawMessage is a compatibility wrapper for runtime pull.
...
// AckOpenClawDelivery is a compatibility wrapper for runtime ack.
func (c *AsyncAPIClient) AckOpenClawDelivery(ctx context.Context, deliveryID string) error {
	return c.AckRuntimeDelivery(ctx, deliveryID)
}

// AckOpenClawDeliveryAsync is a compatibility wrapper for runtime async ack.
...
// NackOpenClawDelivery is a compatibility wrapper for runtime nack.
func (c *AsyncAPIClient) NackOpenClawDelivery(ctx context.Context, deliveryID string) error {
	return c.NackRuntimeDelivery(ctx, deliveryID)
}

// NackOpenClawDeliveryAsync is a compatibility wrapper for runtime async nack.
